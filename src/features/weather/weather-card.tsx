...
import { auroraActivityLabel, moonPhase, notableSkyEventForDate, timeGreeting, weatherAnimation, weatherOrbClass } from "@/features/home/model";
...
export function WeatherCard({ weather, dark, sunTimes, auroraActivity, cometCloseApproach, onOpenForecast }: WeatherCardProps) {
