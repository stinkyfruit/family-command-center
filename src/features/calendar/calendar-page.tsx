...
export const CalendarPage = memo(function CalendarPage({
  ...
  return <section className="rounded-[1.75rem] bg-white p-5 shadow-sm ring-1 ring-slate-100 dark:bg-white/5 dark:ring-white/10 md:p-7">
    ...
    {view === "Day" ? <DayCalendar date={anchor} events={events} members={members} onEdit={onEditEvent} /> : view === "Week" ? <WeekCalendar anchor={anchor} events={events} members={members} onEdit={onEditEvent} onOpenDay={onOpenDay} /> : <MonthGrid anchor={anchor} events={events} members={members} onOpenDay={onOpenDay} />}
