...
export const HomeDashboard = memo(function HomeDashboard({
  ...
  return <>
    <WeatherNoticeBanner weather={weather} forecast={weatherForecast} insights={weatherInsights} auroraActivity={auroraActivity} cometCloseApproach={cometCloseApproach} onOpenForecast={onOpenWeatherForecast} />
    <section className="grid min-w-0 grid-cols-[minmax(0,1fr)] gap-5 lg:grid-cols-[1.15fr_1fr_1fr]">
      ...
      <div className="min-w-0 md:hidden"><PhoneHomeCalendar anchor={calendarAnchor} events={visibleCalendarEvents} members={members} onOpenCalendar={onOpenCalendar} onOpenEvent={onOpenEvent} onAddEvent={onAddEvent} /></div>
