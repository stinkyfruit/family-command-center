...
export function HomeDashboard({
  ...
  return <>
    <section className="grid min-w-0 grid-cols-[minmax(0,1fr)] gap-5 lg:grid-cols-[1.15fr_1fr_1fr]">
      <WeatherCard weather={weather} dark={dark} sunTimes={sunTimes} auroraActivity={auroraActivity} cometCloseApproach={cometCloseApproach} onOpenForecast={onOpenWeatherForecast} />
