...
function SettingsPage({ choreRewardMode, choreRewardTargetCents, choreRewardTargetStars, earnedCentsByMember, paidOutCentsByMember, onPayOut, onResetToday, onClearAll, onRewardModeChange, chores, onEditReward, ...props }: SettingsPageProps) {
