...
function TabLoading({ label }: { label: string }) {
  return <section className="w-full min-w-0"><div className="rounded-[2rem] bg-white p-8 text-center shadow-sm ring-1 ring-slate-100 dark:bg-white/5 dark:ring-white/10" role="status" aria-live="polite"><p className="font-black">Loading {label}…</p><p className="mt-1 text-sm font-semibold text-slate-400">Getting this family section ready.</p></div></section>;
}
