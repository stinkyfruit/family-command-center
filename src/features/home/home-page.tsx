...
import { AppIcon, SpeechInputButton, useAppNotifications } from "@/components/home/shared-ui";
...
import { CalendarPage, CalendarPreview } from "@/features/calendar/calendar-page";
      ...
      <div className={`relative min-h-full transition-colors lg:pl-24 ${activeTab === "wishlist" ? "christmas-home-shell text-white" : "bg-[#f8f7ff] text-slate-900 dark:bg-[#151522] dark:text-slate-100"}`}>
        ...
        {(activeTab === "home" || activeTab === "calendar") ? <div className="mx-auto w-full min-w-0 max-w-[1800px] space-y-5 px-5 pb-24 md:px-9 lg:pb-8">{activeTab === "home" && <>
          <section className="grid min-w-0 grid-cols-[minmax(0,1fr)] gap-5 lg:grid-cols-[1.15fr_1fr_1fr]">
            <WeatherCard weather={weather} dark={dark} sunTimes={sunTimes} auroraActivity={auroraActivity} cometCloseApproach={cometCloseApproach} />
          ...
          <CalendarPreview anchor={calendarAnchor} events={visibleCalendarEvents} members={members} onOpenCalendar={() => setActiveTab("calendar")} onOpenDay={(day) => { setCalendarAnchor(day); setView("Day"); setActiveTab("calendar"); }} /></>}
