...
export type SettingsPageContentProps = {
  ...
  onTabVisibilityChange: (tab: "chores" | "wishlist" | "movie-night" | "family-dinners", visible: boolean) => void;
  onUnlocked?: () => void;
