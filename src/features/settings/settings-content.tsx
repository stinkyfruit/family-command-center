...
export type SettingsPageContentProps = {
  ...
  onTabVisibilityChange: (tab: "chores" | "wishlist" | "movie-night", visible: boolean) => void;
  onUnlocked?: () => void;
