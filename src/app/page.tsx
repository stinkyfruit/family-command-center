...
function ChoreCelebration() {
  return <div className="pointer-events-none absolute inset-0 z-20 grid place-items-center overflow-hidden"><span className="animate-[ping_900ms_ease-out_2] text-7xl">🎉</span><span className="absolute left-[18%] top-[16%] animate-bounce text-4xl">✨</span><span className="absolute right-[16%] top-[20%] animate-[bounce_700ms_ease-in-out_2] text-4xl">🌈</span><span className="absolute bottom-[16%] left-[25%] animate-[ping_1s_ease-out_2] text-3xl">⭐</span><span className="absolute bottom-[18%] right-[25%] animate-[bounce_800ms_ease-in-out_2] text-3xl">💫</span></div>;
}
