...
export default function Home() {
  ...
  function addEvent(event: FormEvent) {
    ...
    const endsAt = eventAllDay ? null : new Date(startsAt.getTime() + 60 * 60_000);
