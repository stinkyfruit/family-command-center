...
export async function POST(request: NextRequest) {
  try {
    ...
    url.search = new URLSearchParams({ client_id: process.env.GOOGLE_CALENDAR_CLIENT_ID ?? "", redirect_uri: process.env.GOOGLE_CALENDAR_REDIRECT_URI ?? "", response_type: "code", access_type: "offline", prompt: "consent select_account", scope: "https://www.googleapis.com/auth/calendar.readonly", state }).toString();
