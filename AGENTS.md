...
- **Supabase / Tailwind / other libraries:** consult the Context7 MCP server (`.mcp.json` in the repo root) via `resolve-library-id` + `query-docs` for current, version-specific docs.
